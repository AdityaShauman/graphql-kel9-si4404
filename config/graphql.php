...
use App\GraphQL\Queries\MovieQuery;
use App\GraphQL\Queries\MoviesQuery;
use App\GraphQL\Mutations\CreateMovieMutation;
use App\GraphQL\Mutations\DeleteMovieMutation;
use App\GraphQL\Mutations\UpdateMovieMutation;
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'movies' => MoviesQuery::class,
            ],
            'mutation' => [
                // Create a movie
                'createMovie' => CreateMovieMutation::class,
                // update movie
                'updateMovie' => UpdateMovieMutation::class,
                // delete a movie
                'deleteMovie' => DeleteMovieMutation::class,
            ],
